...
<!-- article 영역 시작 -->
 ...
 <%-- Content 내용들어 갈자리 --%>   
         ...
         <form method="post" action="surveyUpdate" enctype="multipart/form-data">
 <table id = "surveyclient">
  ...
  <c:forEach var="e" items="${list }" varStatus="i"  >
  	<c:if test="${i.index ==0 }">
   <tr><th>제목</th><td>
   <input type="text" name="sub" id="sub" value="${e.sub }" readonly="readonly">
  ...
  <!--  <tr><th>문항수</th><td><input type="number" name="code" id="code"></td></tr> -->
   ...
   <td>
   <input type ="radio" name="surveytype" class="surveytitel" value="${e.surveytype}" >${e.surveytitel}</td></tr>
  </c:forEach>
  
  </tbody>
  <tfoot>
  <tr><th colspan="2">
  <input type="submit"  value="send" id="listBtn">
